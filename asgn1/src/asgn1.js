...
function UIElements(){
  ...
  // Clear Canvas
  document.getElementById('clear').onclick = function(){gl.clearColor(0.0, 0.0, 0.0, 1.0);  gl.clear(gl.COLOR_BUFFER_BIT); g_points = [];
  g_colors = []; g_selectedColor= [1.0,1.0,1.0,1.0];}
