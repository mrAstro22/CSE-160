...
class Vector3 {
    ...
    div(scalar) {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        this.elements[0] = this.elements[0] / scalar; // x
        this.elements[1] = this.elements[1] / scalar; // y
        this.elements[2] = this.elements[2] / scalar; // z
    ...
    static dot(other1, other2) {
        // Compute magnitudes
        let mag1 = other1.magnitude();
        let mag2 = other2.magnitude();

        // 2Compute cosine of angle using component formula
        // cos(alpha) = (v1•v2) / (||v1||*||v2||)
        let compDot = other1.elements[0]*other2.elements[0] +
                      other1.elements[1]*other2.elements[1] +
                      other1.elements[2]*other2.elements[2];

        let cosAlpha = compDot / (mag1 * mag2);


        // Return using Formula
        return mag1 * mag2 * cosAlpha;
    }
